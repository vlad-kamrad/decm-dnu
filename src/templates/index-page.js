...
import un1 from "../img/1unsplash.jpeg";
import un4 from "../img/4unsplash.jpeg";

const imageCoverList = [
  un1,
  un4,
  /* "../img/1unsplash.jpeg", */
  /*   "../img/2unsplash.jpeg",
...
const _cardInformation = () => {
  return (
    <>
      <div>Дніпровський Національний Університет імені Олеся Гончара</div>
      <div>кафедра Електронних Обчислювальних Машин</div>
      <div className="sm">Спеціальність</div>
      <div>123 – Комп’ютерна інженерія</div>
    </>
  );
};
